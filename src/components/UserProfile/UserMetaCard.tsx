      ...
      <div className="p-5 border border-[#a3b18a] rounded-2xl bg-white">
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            <div className="w-20 h-20 overflow-hidden border border-[#a3b18a] rounded-full">
              <img
            ...
            <div className="order-3 xl:order-2">
              <h4 className="mb-2 text-lg font-semibold text-center text-[#344e41] xl:text-left">
          ...
          <button
            onClick={openModal}
            className="flex w-full items-center justify-center gap-2 rounded-full border border-[#a3b18a] bg-white px-4 py-3 text-sm font-medium text-[#344e41] hover:bg-[#dad7cd] hover:text-[#344e41] xl:inline-flex xl:w-auto"
          >
            <svg
